...
| [`14-architecture-decisions.md`](docs/14-architecture-decisions.md) | **18 ADRs** |
...
| [`26-pwa-metrics-and-mobile-decision.md`](docs/26-pwa-metrics-and-mobile-decision.md) | **PWA-mätning (anonyma aggregat) & A→B mobilapp-beslut** |
