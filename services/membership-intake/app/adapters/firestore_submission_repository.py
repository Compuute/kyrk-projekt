...
def _submission_to_doc(s: IntakeSubmission) -> dict:
    return {
        ...
        "monthly_fee_sek": s.monthly_fee_sek,
        "source": s.source,
...
def _doc_to_submission(data: dict) -> IntakeSubmission:
    return IntakeSubmission(
        ...
        monthly_fee_sek=data.get("monthly_fee_sek", 200),
        action=data.get("action", "register_only"),
        tax_consent=data.get("tax_consent", False),
