...
> Innan skarp lansering: se [`governance/pre-production-audit-checklist.md`](governance/pre-production-audit-checklist.md)
> för de blockerande grindarna (residens, DPIA, Art. 9, DPA).
