# 21 — Benchmark: Kyrko-drivna begravningstjänster globalt

Datadrivet underlag: vilka kyrkor och religiösa samhällen driver
begravningstjänster? Vad kan vi lära oss?
...
| Syrisk-ortodoxa | Nej | Ceremoni, hänvisar till Fonus |
...
**Detta är den viktigaste benchmarken.** Chevra Kadisha
(חברא קדישא, "det heliga sällskapet") är den närmaste parallellen
till vad vi bygger.

### Hur det fungerar

```
CHEVRA KADISHA                    VÅR MODELL
──────────────                    ──────────
Tahara (rituell tvagning)    ↔    ንጽሕና (rituell tvagning)
Shmirah (vakta kroppen)      ↔    ሐዘን (vigil/vaktnatt)
Tachrichim (svepning)        ↔    Traditionell klädsel
Kevurah (jordbegravning)     ↔    Jordbegravning österut
Shiva (7 dagar sorg)         ↔    ሐዘን (3-40 dagar sorg)
Shloshim (30 dagar)          ↔    ተዝካር dag 40
...
1. **Community ownership** — ingen extern ägare tar vinst
2. **Volontärarbete** — Tahara utförs gratis av frivilliga (mitzvah)
3. **Standardisering** — alla begravningar likadana (enkel kista, vit svepning)
4. **Ingen upselling** — filosofi: döden gör alla lika
5. **Religiös plikt** — att hjälpa med begravning ses som helig tjänst

### Vad vi lär oss och tar med

| Chevra Kadisha-princip | Vår tillämpning |
|---|---|
| Volontärarbete (Tahara) | Rituell tvagning av kyrkans diakoner (volontär) |
...
|---|---|---|
| Islamiska Förbundet | Nationellt | Rådgivning, ej byrå |
| Diverse moskéer | Stockholm, Malmö, Göteborg | Ceremoni + rituell tvagning |
| Muslimska begravningsplatser | Nacka, Malmö | Gravplatser |

**Ingen moské i Sverige driver en formell begravningsbyrå.**
Samma vakuum som för ortodoxa.
...
Eder är en **1 000+ år gammal** etiopisk tradition. Det är en
ömsesidig stödförening där medlemmar betalar månadsavgift och
föreningen täcker kostnader vid dödsfall.

### Hur Eder fungerar

```
MÅNADSAVGIFT: 100-500 kr per hushåll
                ↓
KASSA: Ackumuleras över tid
                ↓
VID DÖDSFALL:
  → Eder betalar ut 20 000-50 000 kr till familjen
  → Eder-medlemmar hjälper med praktisk logistik
  → Familjen använder pengarna för begravning
                ↓
IDAG:
  Familjen ringer Fonus → betalar 40 000+ kr
  (Eder-pengarna räcker knappt)

MED VÅR TJÄNST:
  Familjen kontaktar kyrkan → betalar 19 000-35 000 kr
  (Eder-pengarna räcker med marginal)
...
Eder-föreningarna är **färdiga distributionskanaler**:
- De har redan medlemmar som betalar för begravningstjänst
- De har redan kassaflöde
- De saknar logistik-kompetens (det vi erbjuder)
- Vi kompletterar varandra perfekt

```
UTAN OSS:                          MED OSS:
Eder → pengar → familj → Fonus    Eder → pengar → kyrkan → familj sörjer
...
| Kriterium | Chevra Kadisha | Black church (USA) | Muslim coop (UK) | Eder | **Vår modell** |
|---|---|---|---|---|---|
| Ålder | 500+ år | 150+ år | 30+ år | 1 000+ år | **Ny** |
| Antal globalt | ~2 000 | ~3 500 | ~200 | ~10 000+ | **1 (först)** |
| Volontär-drivet? | Ja | Delvis | Ja | Ja | Ja + AI |
| Professionellt? | Delvis | Ja | Delvis | Nej | **Ja** |
| Digital plattform? | Sällan | Nej | Nej | Nej | **Ja — AI-native** |
| Hemtransport? | Till Israel | Nej | Till hemland | Informellt | **Ja — kärntjänst** |
| Flerspråkigt? | Hebreiska+eng | Engelska | Arabiska+eng | Amhariska | **Am+Ti+Sv+En** |
| Transparent prissättning? | Ja | Varierande | Ja | N/A | **Ja** |
| Sorg-kalender? | Ja (manuell) | Nej | Nej | Informellt | **Ja (automatisk)** |
| AI-dokumentation? | Nej | Nej | Nej | Nej | **Ja** |
| Skalbar till andra grupper? | Nej (judisk) | Nej (afroam.) | Delvis | Nej (etiopisk) | **Ja** |

## Slutsats: Vad som gör vår modell unik

**Ingen kyrka i Sverige, Tyskland eller USA erbjuder det vi
planerar.** Specifikt:

### Vad som redan finns (och fungerar)

1. Chevra Kadisha — bevisad modell i 500 år, community-driven,
   billigare än kommersiellt
2. Black church funeral homes — bevisad modell i 150 år,
   kyrko-ägd, community trust
3. Muslim cooperatives — bevisad modell i 30 år, skalade
   till 4 000 begravningar/år (Gardens of Peace)
4. Eder — bevisad modell i 1 000 år, redan i vår community

### Vad som INTE finns (och som vi bygger)

| Innovation | Status globalt |
|---|---|
| AI-native begravningsplattform | **Finns inte** |
| Digital hemtransport-tracker | **Finns inte** |
| Automatisk sorg-kalender (push-notiser) | **Finns inte** |
| AI-genererad flerspråkig dokumentation | **Finns inte** |
| Transparent online-prissättning (ortodox) | **Finns inte** |
| Multi-kyrka begravningsnätverk | **Finns inte** |
| Eder + kyrka + digital plattform integration | **Finns inte** |

### Vår unika position

```
BEVISADE MODELLER          +    TEKNOLOGI           =    VÅR MODELL
───────────────                 ──────────                ──────────
Chevra Kadisha (500 år)         AI (Claude)               Kulturell kompetens
...
Vi uppfinner inte hjulet. Vi tar **bevisade modeller** som har
fungerat i hundratals år och lägger till **modern teknologi**.

Det är exakt vad Fenix (96 M SEK omsättning) och Lavendla
(53 M SEK) gjorde med den svenska marknaden — men de saknar
