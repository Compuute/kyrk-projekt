...
Sverige till Etiopien. Varje steg har:
- Vilket dokument
...
DAG 3-5: AMBASSAD
  □ Etiopiska ambassaden kontaktad
...
|---|---|---|
| Turkish Airlines Cargo | ARN → IST → ADD | Dagliga avgångar, bra backup-rutt |
...
| Mottagning i Addis Abeba | 3 000 – 5 000 kr |
