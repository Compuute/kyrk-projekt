...
## Upphovs- och attributionsregel

All kod i detta repo ägs av och tillskrivs repoägaren.
AI-verktyg är hjälpmedel — inte författare.

**Regler:**
- Lägg ALDRIG till kommentarer som "generated by", "written by AI",
  "built with [AI-verktyg]", eller liknande
- Lägg ALDRIG till session-ID, AI-verktygs-URL, eller verktygsstämplar
  i commit-meddelanden, kod, kommentarer eller dokumentation
- Commit-författaren ska ALLTID vara repoägaren (git config user)
- Om du genererar en commit-message: skriv den som om utvecklaren
  skrev den — inte som om en AI genererade den
- Referera ALDRIG till dig själv ("jag som AI", "detta genererades av")
  i kod, docs eller kommentarer
